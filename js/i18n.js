...
const I18N = {
  en: {
    ...
    "nav.about": "About",
    // Hero
    "hero.title": "Make Money as an Independent Creator",
    "hero.subtitle": "From zero to income — build sustainable online revenue as a solo creator",
    // Tags
    "tag.tools": "Tools",
    "tag.sidehustle": "Side Hustles",
    "tag.digital": "Digital Products",
    "tag.ai": "AI",
    // Filter
    "filter.all": "All",
    "filter.digital": "Digital Products",
    "filter.ai": "AI Tools",
    "filter.sidehustle": "Side Hustles",
    ...
    // Articles
    "article.gumroad.title": "Gumroad Beginner's Guide: From Signup to First Sale",
    "article.gumroad.desc": "Step-by-step guide to setting up Gumroad, uploading products, pricing, and making your first sale within 7 days.",
    "article.gumroad.readtime": "12 min read",
    "article.gumroad.date": "2026-06-30",
    "article.notion-templates.title": "Can You Make Money Selling Notion Templates? Real Income Data for 2026",
    "article.notion-templates.desc": "Break down 10 real case studies of selling Notion templates — which ones sell best, how to price, and real profit numbers.",
    "article.notion-templates.readtime": "10 min read",
    "article.notion-templates.date": "2026-06-29",
    "article.ideas.title": "15 Most Profitable Digital Product Ideas for 2026",
    "article.ideas.desc": "From ebooks to Notion templates, preset packs to online courses — the most promising digital product categories this year.",
    "article.ideas.readtime": "8 min read",
    "article.ideas.date": "2026-06-28",
    "article.ai-writing.title": "Best AI Writing Tools 2026: ChatGPT vs Claude vs DeepSeek",
    "article.ai-writing.desc": "Hands-on comparison of the top three AI writing tools — which one is best for articles, code, and marketing copy.",
    "article.ai-writing.readtime": "14 min read",
    "article.ai-writing.date": "2026-06-27",
    "article.free-ai.title": "10 Free AI Tools Every Creator Should Know",
    "article.free-ai.desc": "From image generation to video editing, copywriting to voiceovers — free AI tools that save you hours of work.",
    "article.free-ai.readtime": "9 min read",
    "article.free-ai.date": "2026-06-26",
    "article.affiliate.title": "Affiliate Marketing for Beginners: Is It Still Worth It in 2026?",
    "article.affiliate.desc": "The fundamentals of affiliate marketing, product selection strategies, promotion channels, and the best programs to join this year.",
    "article.affiliate.readtime": "15 min read",
    "article.affiliate.date": "2026-06-26",
    "article.upwork.title": "Upwork Freelancing Guide: From Signup to $1,000/Month",
    "article.upwork.desc": "How to land clients on Upwork, write winning proposals, optimize your profile, and negotiate rates like a pro.",
    "article.upwork.readtime": "12 min read",
    "article.upwork.date": "2026-06-24",
    "article.notion-workflow.title": "Build a Personal Workflow in Notion: From Chaos to Clarity",
    "article.notion-workflow.desc": "Manage tasks, projects, notes, and knowledge bases — a complete Notion workflow setup tutorial for solo creators.",
    "article.notion-workflow.readtime": "11 min read",
    "article.notion-workflow.date": "2026-06-25",
    "article.automation.title": "No-Code Automation: Zapier + Make Practical Guide",
    "article.automation.desc": "Automate without writing code. RSS to email, forms to databases, social media scheduling — 10 real-world workflows.",
    "article.automation.readtime": "12 min read",
    "article.automation.date": "2026-06-21",
    "article.cloudflare.title": "Cloudflare for Indie Makers: The Complete Free Tier Guide",
    "article.cloudflare.desc": "Domain, hosting, CDN, analytics, security — everything Cloudflare's free plan can do for your indie maker site.",
    "article.cloudflare.readtime": "14 min read",
    "article.cloudflare.date": "2026-06-17",
    // Article bodies
    "article.affiliate.body": `<p>"Affiliate marketing is dead" — someone says this every few years. The reality: the global affiliate marketing market is projected to exceed $200 billion in 2026. What's dead is the spam farms and content scrapers. Those who put in real effort are actually finding it easier to stand out.</p>
    ...
    "article.ai-writing.body": `<p>By 2026, AI writing tools have become essential for content creators. But here's the question: ChatGPT, Claude, DeepSeek — which of these three giants should you choose?</p>
    ...
    "article.automation.body": `<p>Spending 2 hours a day on repetitive tasks? Copy-pasting data, manually posting to social media, sending individual emails... all of this can be automated. No code required.</p>
    ...
    "article.cloudflare.body": `<p>Cloudflare is the indie creator's hidden superpower. Most people think it's just a CDN, but its free tier actually offers 20+ services covering nearly all the infrastructure you need to run a website.</p>
  ...
  Permissions-Policy: camera=(), microphone=(), geolocation=()</pre>
    ...
    "article.free-ai.body": `<p>It's 2026 — are you still manually making graphics and editing videos? The 10 AI tools below all offer free plans, more than enough for most creators' daily needs.</p>
    ...
    "article.gumroad.body": `<p>Gumroad is the most popular digital product sales platform. Whether you want to sell ebooks, Notion templates, design assets, or online courses, Gumroad has you covered.</p>
    ...
    "article.ideas.body": `<p>Want to create digital products but don't know what to sell? This is the most common roadblock. The good news: you don't need to invent anything new — countless people are already making money in these directions.</p>
    ...
    "article.notion-templates.body": `<p>"Can you really make money selling Notion templates?" — I asked the same question two years ago. Now I can answer directly: <strong>Yes, and the income is higher than you'd expect.</strong></p>
    ...
    "article.notion-workflow.body": `<p>Most people use Notion like this: create a page for notes today, create another for tasks tomorrow, and a week later pages are scattered everywhere, nothing can be found. This isn't a Notion problem — it's a missing workflow framework.</p>
    ...
    "article.upwork.body": `<p>Upwork is the world's largest freelancing platform, with over 2 million active projects in 2026. Whether you're a developer, designer, writer, or translator, there are abundant opportunities to land work.</p>
...
[Your Name]</pre>
    ...
    // Newsletter
    "newsletter.title": "One actionable money-making tip every week",
    "newsletter.subtitle": "New tools, real case studies, and step-by-step tutorials. No fluff.",
    "newsletter.button": "Subscribe",
    // Footer
    "footer.copyright": "© 2026 Maker Earn · Helping indie creators build independent income",
    "footer.about": "About",
    "footer.sitemap": "Sitemap",
    // About page
    "about.title": "About Maker Earn",
    "about.intro": "Hi, I'm an indie creator.",
    "about.p1": "Over the past few years, I've tried countless ways to make money online: selling digital products, affiliate marketing, newsletters, freelancing, building tool sites… I've made plenty of mistakes and found a few things that actually work.",
    "about.p2": "<strong>Maker Earn</strong> is where I organize everything I've learned.",
    "about.what": "What we cover",
    "about.li1": "<strong>Digital Products</strong> — Gumroad setup, Notion templates, ebook publishing, online courses",
    "about.li2": "<strong>AI Tools</strong> — Latest AI tool reviews, practical tips for AI-assisted creation",
    "about.li3": "<strong>Side Hustles</strong> — Affiliate marketing, Upwork freelancing, Substack monetization",
    "about.li4": "<strong>Productivity</strong> — Project management, automation, essential tool stack for indie creators",
    "about.why": "Why this site exists",
    "about.why1": "There's too much generic \"make money online\" advice out there — either too vague (\"you need the right mindset\") or too outdated (methods from 2018 don't work in 2026).",
    "about.why2": "I built this site to be <strong>no-fluff, step-by-step, and immediately actionable</strong>. Every article gives you at least one thing you can do right after reading.",
    "about.disclaimer": "Disclosure",
    "about.disclaimer1": "Some articles contain affiliate links. If you purchase through my links, I may earn a small commission at no extra cost to you. I only recommend products I've actually used and trust.",
    // 404 page
    "404.title": "Page Not Found — Maker Earn",
    "404.heading": "This page doesn't exist. The link may have expired or been removed.",
    "404.suggest": "Try going back to the",
    "404.home": "homepage",
    "404.or": "or check out these popular articles:"
  },
  ...
  zh: {
    ...
    "nav.about": "关于",
    // Hero
    "hero.title": "数字创作者独立赚钱指南",
    "hero.subtitle": "从零开始，用数字工具和独立创作建立可持续的在线收入",
    // Tags
    "tag.tools": "工具推荐",
    "tag.sidehustle": "副业搞钱",
    "tag.digital": "数字产品",
    ...
    "filter.digital": "数字产品",
    "filter.ai": "AI 工具",
    "filter.sidehustle": "副业搞钱",
    "filter.productivity": "效率工具",
    // Categories
    "cat.digital": "数字产品",
    "cat.ai": "AI 工具",
    "cat.sidehustle": "副业搞钱",
    ...
    // Articles
    "article.gumroad.title": "Gumroad 新手完全指南：从注册到卖出第一单",
    "article.gumroad.desc": "手把手教你注册 Gumroad、上传产品、设置定价，7 天内搞定你的第一个数字产品。",
    "article.gumroad.readtime": "12 分钟",
    "article.gumroad.date": "2026-06-30",
    "article.notion-templates.title": "Notion 模板能卖钱吗？2026 年真实收入大揭秘",
    "article.notion-templates.desc": "拆解 10 个卖 Notion 模板的真实案例，告诉你哪些模板最好卖、怎么定价、利润有多少。",
    "article.notion-templates.readtime": "10 分钟",
    "article.notion-templates.date": "2026-06-29",
    "article.ideas.title": "2026 年最赚钱的 15 个数字产品创意",
    "article.ideas.desc": "从电子书到在线课程，从模板到预设包，盘点 2026 年最有潜力的数字产品方向。",
    "article.ideas.readtime": "8 分钟",
    "article.ideas.date": "2026-06-28",
    "article.ai-writing.title": "2026 年最佳 AI 写作工具对比：ChatGPT vs Claude vs DeepSeek",
    "article.ai-writing.desc": "实测对比三大 AI 写作工具，告诉你哪款适合写文章、写代码、写营销文案。",
    "article.ai-writing.readtime": "14 分钟",
    "article.ai-writing.date": "2026-06-27",
    "article.free-ai.title": "创作者必备的 10 个免费 AI 工具",
    "article.free-ai.desc": "从图片生成到视频剪辑，从文案到配音，这些免费 AI 工具能帮你省下大把时间。",
    "article.free-ai.readtime": "9 分钟",
    "article.free-ai.date": "2026-06-26",
    "article.affiliate.title": "Affiliate Marketing 入门：2026 年还值得做吗？",
    "article.affiliate.desc": "联盟营销的底层逻辑、选品策略、推广渠道，以及 2026 年最值得加入的联盟计划。",
    "article.affiliate.readtime": "15 分钟",
    "article.affiliate.date": "2026-06-26",
    "article.upwork.title": "Upwork 接单全攻略：从注册到月入 $1000",
    "article.upwork.desc": "怎么通过 Upwork 接单、怎么写 Profile 更容易中标、怎么跟客户谈价格。",
    "article.upwork.readtime": "12 分钟",
    "article.upwork.date": "2026-06-24",
    "article.notion-workflow.title": "Notion 搭建个人工作流：从混乱到高效",
    "article.notion-workflow.desc": "用 Notion 管理任务、项目、笔记、知识库，一套完整的工作流搭建教程。",
    "article.notion-workflow.readtime": "11 分钟",
    "article.notion-workflow.date": "2026-06-25",
    "article.automation.title": "零代码自动化：Zapier + Make 实战教程",
    "article.automation.desc": "不会写代码也能做自动化。从 RSS 到邮件、从表单到数据库，10 个实用自动化场景。",
    "article.automation.readtime": "12 分钟",
    "article.automation.date": "2026-06-21",
    "article.cloudflare.title": "独立创作者的 Cloudflare 全家桶指南",
    "article.cloudflare.desc": "域名、托管、CDN、分析、安全——Cloudflare 免费版能做多少事？全给你讲明白。",
    "article.cloudflare.readtime": "14 分钟",
    "article.cloudflare.date": "2026-06-17",
    // Newsletter
    "newsletter.title": "每周一封搞钱邮件",
    "newsletter.subtitle": "最新工具推荐 + 搞钱案例 + 实战教程，不发废话",
    "newsletter.button": "订阅",
    // Footer
    "footer.copyright": "© 2026 搞钱工具箱 · 帮助数字创作者实现独立收入",
    "footer.about": "关于本站",
    "footer.sitemap": "站点地图",
    // About page
    "about.title": "关于搞钱工具箱",
    "about.intro": "你好，我是一个独立创作者。",
    "about.p1": "在过去几年里，我试过无数种在网上赚钱的方法：卖数字产品、做 Affiliate、写 Newsletter、接 Freelance 项目、建工具站…… 踩过很多坑，也找到了一些真正有效的方法。",
    "about.p2": "<strong>搞钱工具箱</strong> 就是我把这些经验整理出来的地方。",
    "about.what": "这里写什么",
    "about.li1": "<strong>数字产品</strong> — Gumroad 开店、Notion 模板、电子书出版、在线课程",
    "about.li2": "<strong>AI 工具</strong> — 最新 AI 工具测评、AI 辅助创作的实战技巧",
    "about.li3": "<strong>副业搞钱</strong> — Affiliate Marketing、Upwork 接单、Substack 变现",
    "about.li4": "<strong>效率工具</strong> — 项目管理、自动化、独立创作者必备的工具栈",
    "about.why": "为什么做这个站",
    "about.why1": "网上的\"搞钱教程\"太多，但要么太虚（\"你要有 mindset\"），要么太老（2018 年的方法放到 2026 年根本不行）。",
    "about.why2": "我想做一个<strong>不说废话、给出具体步骤、可以照着做</strong>的网站。每篇文章你读完，至少能立刻做一件事。",
    "about.disclaimer": "免责声明",
    "about.disclaimer1": "部分文章包含 Affiliate 链接。如果你通过我的链接购买产品，我可能获得少量佣金，这不会影响你的购买价格。我只推荐我真正用过且认可的产品。",
    // 404 page
    "404.title": "页面未找到 — 搞钱工具箱",
    "404.heading": "这个页面不存在，可能链接过期或已被移除。",
    "404.suggest": "试试回到",
    "404.home": "首页",
    "404.or": "或看看下面的热门文章：",
    // Article bodies
    "article.affiliate.body": `<p>"联盟营销已死"——每隔几年就有人这么说。现实是：2026 年全球联盟营销市场规模预计超过 2000 亿美元。死掉的是垃圾站和内容拼凑器。真正用心做的人，反而更容易脱颖而出。</p>
    <p>这篇指南从零讲起：什么是联盟营销、怎么做、2026 年哪些渠道还能玩。</p>

    <h2>什么是联盟营销？</h2>
    <p>一句话：你推荐别人的产品，别人通过你的链接购买，你赚佣金。不用囤货、不用客服、不用发货。你唯一的工作就是"带人去买"。</p>
    <p>典型流程：写测评/对比文章 → 文末放你的联盟链接 → 读者点击购买 → 你赚 5%-30% 佣金。</p>

    <h2>2026 年还值得做吗？</h2>
    <p>简短回答：<strong>值得，但玩法变了。</strong></p>
    <p>2018 年那套"建 100 个垃圾站互相链接"的玩法已经死了。Google 2024 年有用内容更新把低质量联盟站一锅端。但反面是：认真写干货的网站，流量反而涨了。</p>
    <p><strong>好消息</strong>：AI 工具把"认真写"的成本砍了 90%。以前三天写一篇深度测评，现在有 AI 辅助一天能写三篇。</p>

    <h2>选品：什么好卖？</h2>
    <p>不是所有产品都适合做联盟。关键原则：</p>
    <ul><li><strong>高佣金率</strong>：软件/SaaS 一般 20%-30%，实体商品只有 3%-8%</li><li><strong>长 cookie 期</strong>：有的联盟计划给 90 天 cookie（90 天内购买都算你的），有的只有 24 小时</li><li><strong>复购型产品</strong>：有的计划给续费佣金——用户每月续费，你每月有钱拿</li></ul>
    <h3>2026 年推荐联盟计划</h3>
    <ul><li><strong>软件/SaaS</strong>：Notion、ClickUp、NordVPN、Cloudflare——佣金 20%-40%</li><li><strong>AI 工具</strong>：Jasper、Writesonic、Grammarly——AI 热门赛道，佣金可观</li><li><strong>主机/建站</strong>：SiteGround、Bluehost、Shopify——每单 $50-150</li><li><strong>课程平台</strong>：Skillshare、Coursera——稳定收入流</li></ul>

    <h2>用什么渠道推广？</h2>
    <h3>渠道一：内容站（推荐）</h3>
    <p>建一个垂直博客/网站，写深度文章，嵌入联盟链接。优势：长期积累、被动收入。劣势：起步慢（一般 3-6 个月稳定流量）。</p>
    <h3>渠道二：YouTube</h3>
    <p>做产品测评/教程视频，描述区放联盟链接。视频 SEO 竞争比图文小，YouTube 是全球第二大搜索引擎。</p>
    <h3>渠道三：Newsletter</h3>
    <p>建邮件列表，定期推荐工具和产品。转化率通常比网站高（订阅者已经信任你）。</p>
    <h3>渠道四：社交媒体</h3>
    <p>Twitter/X 和某些 Reddit 社区允许推荐帖。但要遵守平台规则——发链接垃圾会被封。</p>

    <h2>新手路线图</h2>
    <ol><li><strong>第一周</strong>：选一个细分方向（如"独立开发者工具"或"远程办公软件"）</li><li><strong>第二周</strong>：注册 3-5 个联盟计划（Impact、PartnerStack、ShareASale 是最大的平台）</li><li><strong>第三四周</strong>：写 5 篇深度文章，每篇推荐 2-3 个产品</li><li><strong>第二个月</strong>：开始推广文章（社交媒体、SEO、相关论坛）</li><li><strong>第三到六个月</strong>：根据数据优化高转化文章，砍掉效果差的</li></ol>

    <h2>重要提醒</h2>
    <blockquote>永远不要为了佣金推荐烂产品。你的信誉比一次佣金值一万倍。只推荐你真的用过、真心认可的产品。</blockquote>
    <p>另外，大多数国家要求联盟披露（FTC 规则）。诚实标注"本文含有联盟链接"不仅合规——实际上更能增加读者信任。</p>`,
    "article.ai-writing.body": `<p>到 2026 年，AI 写作工具已经成为内容创作者的必备装备。但问题来了：ChatGPT、Claude、DeepSeek——这三巨头该选哪个？</p>
    <p>我花了两个月时间，用这三款工具写了超过 200 篇文章，测试了中文写作、代码生成、营销文案和 SEO 优化。以下是真实结果。</p>
    ...
    <table style="width:100%;border-collapse:collapse;margin:1em 0">
      ...
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">长文写作</td><td>⭐⭐⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td></tr>
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">编程</td><td>⭐⭐⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td></tr>
    ...
    <h2>ChatGPT（OpenAI）</h2>
    <h3>优势</h3>
    <ul><li><strong>最完整的生态</strong>：插件、API、DALL-E 图片生成、代码解释器——全在一个产品里</li><li><strong>英文写作最强</strong>：英文文章、邮件、营销文案几乎完美</li><li><strong>社区最大</strong>：教程多、案例多，遇到问题容易找到答案</li></ul>
    <h3>劣势</h3><ul><li>中文输出有时生硬，翻译感明显</li><li>长文逻辑有时跳跃，需要人工检查</li><li>$20/月不便宜，高频使用可能触发限速</li></ul>
    <h3>最适合</h3><p>需要多模态能力（文字+图片+代码）的创作者；主要以英文写作为主的人。</p>

    <h2>Claude（Anthropic）</h2>
    <h3>优势</h3><ul><li><strong>长文写作第一</strong>：200K 上下文——能一次性处理整本书，长文逻辑最连贯</li><li><strong>中文比 ChatGPT 自然</strong>：翻译感少，更接近人写的中文</li><li><strong>编程能力出色</strong>：复杂项目和架构设计表现突出</li></ul>
    <h3>劣势</h3><ul><li>没有图片生成能力</li><li>免费版消息条数少</li><li>偶尔"过度谨慎"，拒绝回答无害问题</li></ul>
    <h3>最适合</h3><p>长文写手（5000+ 字）；需要写代码的独立开发者。</p>

    <h2>DeepSeek</h2>
    <h3>优势</h3><ul><li><strong>中文第一</strong>：最自然流畅的中文写作，几乎没有 AI 味</li><li><strong>性价比爆表</strong>：API 定价是 OpenAI 的 1/10，月费只要几块钱</li><li><strong>开源模型</strong>：可以自己部署，数据不外泄</li></ul>
    <h3>劣势</h3><ul><li>英文写作略逊于 ChatGPT 和 Claude</li><li>生态（插件等）比 OpenAI 小</li><li>高峰期可能排队</li></ul>
    <h3>最适合</h3><p>主要写中文的内容创作者；预算有限但需要高质量 AI 辅助的人。</p>

    <h2>我的实际工作流</h2>
    <p>我不会只用一款。目前我的配置：</p>
    <ul><li><strong>中文文章初稿</strong> → DeepSeek（最自然、最便宜）</li><li><strong>英文内容</strong> → Claude（英文好、长文连贯）</li><li><strong>写代码/建网站</strong> → Claude + ChatGPT，交替用</li><li><strong>配图生成</strong> → ChatGPT（内置 DALL-E）</li></ul>
    <p>月总花费不到 $30，覆盖我所有内容创作需求。</p>`,
    "article.automation.body": `<p>每天花 2 小时做重复性工作？复制粘贴数据、手动发社交媒体、一封封发邮件……这些全都可以自动化。不需要写代码。</p>

    <h2>Zapier vs Make：选哪个？</h2>
    <table style="width:100%;border-collapse:collapse;margin:1em 0">
      <tr style="background:var(--accent-light)"><th style="padding:.5em;text-align:left">对比</th><th style="padding:.5em">Zapier</th><th style="padding:.5em">Make</th></tr>
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">上手难度</td><td>⭐ 极低</td><td>⭐⭐ 中等</td></tr>
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">免费额度</td><td>100 任务/月</td><td>1000 操作/月</td></tr>
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">连接数</td><td>5000+</td><td>2000+</td></tr>
      <tr style="border-bottom:1px solid var(--border)"><td style="padding:.5em">可视化</td><td>线性流程</td><td>画布式流程</td></tr>
      <tr><td style="padding:.5em">最适合</td><td>简单连接</td><td>复杂多步骤</td></tr>
    </table>
    <p><strong>建议</strong>：新手从 Zapier 开始。免费额度用完切 Make（免费额度多 10 倍，功能更强）。</p>

    <h2>10 个实用自动化场景</h2>
    <h3>1. RSS → 邮件（内容监控）</h3>
    <p>用 Make 监控竞品博客 RSS，有新文章自动发邮件提醒。配置：RSS 模块（定时检查）→ 邮件模块（发通知）。10 分钟搞定。</p>
    <h3>2. Google 表单 → Notion 数据库</h3>
    <p>用户填表 → 自动写入 Notion 数据库。做客户管理、反馈收集、问卷汇总超好用。配置：Google 表单触发器 → Notion 创建条目。</p>
    <h3>3. 自动发社交媒体</h3>
    <p>在 Notion 写内容 → 定时自动发到 Twitter 和 LinkedIn。用 Make 的调度器：Notion 查询 → 文本处理 → Twitter API 发布。</p>
    <h3>4. 邮件附件自动存云盘</h3>
    <p>Gmail 收到带附件的邮件 → 自动下载 → 保存到 Google Drive/OneDrive。Gmail 触发器 → 检测附件 → Drive 上传。</p>
    <h3>5. 电商订单 → 自动感谢信</h3>
    <p>Gumroad 新订单 → 自动提取买家邮箱 → 发送个性化感谢信 + 使用指南。</p>
    <h3>6. 日历活动 → Slack 提醒</h3>
    <p>Google Calendar 明天有会议 → 今晚 8 点自动发 Slack/Discord 提醒。再也不忘明天的事。</p>
    <h3>7. 表单提交 → 自动生成发票 PDF</h3>
    <p>客户通过表单提交项目信息 → 自动生成发票 PDF → 邮件发给客户。自由职业者的全自动开票。</p>
    <h3>8. 新 YouTube 视频 → 自动摘要到博客</h3>
    <p>你发了新 YouTube 视频 → Make 抓取标题和描述 → 发给 AI 生成文字版 → 发布到你的博客。</p>
    <h3>9. 数据备份自动化</h3>
    <p>每天凌晨 2 点，自动导出 Notion 数据库为 CSV，备份到 Google Drive。基础数据安全保障。</p>
    <h3>10. 竞品监控面板</h3>
    <p>定时抓取竞品网站变化（新文章、新功能）→ 汇总到 Notion 数据库 → 自动通知你。</p>

    <h2>搭建技巧</h2>
    <ol><li><strong>先列需求再搭建</strong>：写下你每周重复做的 5 件事。先自动化最花时间的那件</li><li><strong>从简单的开始</strong>：别一上来就搞 10 步的复杂流程。先做 2-3 步的小自动化，再组合</li><li><strong>加错误通知</strong>：每个自动化都加一个"失败了通知我"的步骤，防止静默罢工</li></ol>`,
    "article.cloudflare.body": `<p>Cloudflare 是独立创作者的隐藏外挂。大多数人只知道它是 CDN，实际上它的免费版有 20+ 个服务，覆盖了你建站需要的几乎所有基础设施。</p>

    <h2>免费版能做什么？</h2>
    <ul><li>托管静态网站（Pages，无限带宽）</li><li>注册和管理域名（比 Namecheap 便宜）</li><li>全球 CDN 加速</li><li>DDoS 防护</li><li>免费 SSL 证书</li><li>网站分析（不用依赖 Google Analytics）</li><li>Serverless 函数（Workers，每天 10 万次免费请求）</li><li>KV 存储、D1 数据库（有免费额度）</li><li>表单处理、邮件路由</li><li>图片优化、缓存规则</li></ul>

    <h2>第一步：域名注册</h2>
    <p>.com 域名大约 $10/年。去 Cloudflare Dashboard → 域名注册，搜索购买即可。</p>

    <h2>第二步：网站托管（Pages）</h2>
    <p>如果你的站是纯静态（HTML+CSS+JS，像这个内容站），Cloudflare Pages 是最佳选择：</p>
    <ul><li>直接连 GitHub 仓库——推送代码，自动部署</li><li>全球 330+ 边缘节点，访问速度极快</li><li>无限带宽、无限请求（免费）</li><li>内置预览部署（每个 PR 自动生成预览 URL）</li></ul>
    <p>部署步骤：Pages → 创建项目 → 连接 GitHub 仓库 → 设置构建命令（纯静态选 None）→ 部署。全程 2 分钟。</p>

    <h2>第三步：分析（Web Analytics）</h2>
    <p>Google Analytics 臃肿、不保护隐私、被很多浏览器拦截。Cloudflare Web Analytics 是更好的选择：</p>
    <ul><li>服务端数据，不被 AdBlock 拦截</li><li>不追踪个人隐私，不需要弹 cookie 提示</li><li>核心指标全有：PV、UV、来源、国家、设备</li><li>完全免费</li></ul>
    <p>去 Dashboard → 分析与日志 → Web Analytics，添加你的网站，把 JS 代码放到页面的 &lt;head&gt; 里。</p>

    <h2>第四步：基础安全配置</h2>
    <h3>SSL/TLS</h3>
    <p>Cloudflare 默认提供免费 SSL 证书。在 SSL/TLS 设置中选"完全（严格）"，确保访问者和 Cloudflare 之间、Cloudflare 和你的服务器之间都加密。</p>
    <h3>安全 Headers</h3>
    <p>在 Pages 项目根目录创建 <code>_headers</code> 文件：</p>
    <pre>/*
  X-Frame-Options: DENY
  X-Content-Type-Options: nosniff
  Referrer-Policy: strict-origin-when-cross-origin
  Permissions-Policy: camera=(), microphone=(), geolocation=()</pre>
    <h3>缓存规则</h3>
    <p>在 Dashboard → 缓存 → 缓存规则中设置：</p>
    <ul><li>HTML 文件：缓存 1 小时（更新及时生效）</li><li>CSS/JS/图片：缓存 1 个月（这些很少变，更新用版本号文件名）</li></ul>

    <h2>第五步：其他实用功能</h2>
    <h3>Workers（Serverless 函数）</h3>
    <p>需要简单的后端逻辑（表单提交、API 代理、A/B 测试）？Workers 每天 10 万次免费请求。几行 JS 就能跑。</p>
    <h3>邮件路由</h3>
    <p>想要 hello@你的域名.com 但不想维护邮件服务器？Cloudflare 邮件路由把你的域名邮件转发到你的 Gmail——免费。</p>
    <h3>Zaraz（第三方脚本管理）</h3>
    <p>你的网站加载 GA、Facebook Pixel、Hotjar……这些第三方脚本拖慢速度。Zaraz 通过 Cloudflare 边缘网络加载它们——更快，更保护用户隐私。</p>

    <h2>总结：独立创作者标配栈</h2>
    <p>一个内容站的最小 Cloudflare 配置：</p>
    <ul><li>域名：Cloudflare 注册商</li><li>托管：Cloudflare Pages（连 GitHub）</li><li>CDN/安全：默认开启</li><li>分析：Web Analytics</li><li>邮件：邮件路由 → 转发到 Gmail</li></ul>
    <p>年花费：域名 $10。其他：$0。</p>`,
    "article.free-ai.body": `<p>都 2026 年了，你还在手动做图和剪视频吗？下面这 10 个 AI 工具全都有免费版，对大多数创作者来说完全够用。</p>

    <h2>写作与内容</h2>
    <h3>1. DeepSeek（写作助手）</h3>
    <p>中文写作最强 AI。速度快、质量高、几乎零成本。API 定价只有 OpenAI 的十分之一。写文章、翻译、改写、排版——一个工具搞定。</p>
    <p><strong>免费额度</strong>：每日数十次对话，轻度用户完全够用</p>
    <h3>2. Perplexity AI（AI 搜索）</h3>
    <p>搜索引擎级别的 AI 助手。跟 ChatGPT 最大的区别：每条回答都附来源链接，不用担心 AI 瞎编。做调研必备。</p>
    <p><strong>免费额度</strong>：每天约 20 次深度搜索</p>
    <p><strong>网址</strong>：perplexity.ai</p>

    <h2>图片与设计</h2>
    <h3>3. Leonardo AI（AI 图片生成）</h3>
    <p>画质堪比 Midjourney，但每天有 150 次免费额度。自带图片编辑、扩展、换背景——设计素材利器。</p>
    <p><strong>免费额度</strong>：150 tokens/天</p>
    <h3>4. Canva AI（设计 + AI）</h3>
    <p>Canva 的 AI 越来越强：AI 生图、去背景、魔法扩展、自动配色。免费版就能搞定社媒图、缩略图、简单海报。</p>
    <p><strong>免费额度</strong>：核心功能免费，AI 功能有次数限制</p>
    <h3>5. Remove.bg（一键去背景）</h3>
    <p>严格来说不是新 AI 工具，但超实用。上传图片，背景瞬间消失。免费版：每月 50 张。做素材必备。</p>
    <p><strong>免费额度</strong>：50 张/月</p>

    <h2>视频与音频</h2>
    <h3>6. CapCut（AI 视频剪辑）</h3>
    <p>自动字幕、AI 配音、智能剪辑、一键成片。免费版功能比很多付费剪辑工具都多。每个短视频创作者的必备工具。</p>
    <p><strong>免费额度</strong>：所有核心功能免费</p>
    <h3>7. ElevenLabs（AI 配音）</h3>
    <p>文字转语音的天花板。声音自然到你听不出是 AI。适合视频配音、播客录制。免费版：每月 10 分钟。</p>
    <p><strong>免费额度</strong>：10 分钟/月</p>

    <h2>效率与工作流</h2>
    <h3>8. Notion AI（笔记 + AI）</h3>
    <p>Notion 的 AI 能总结笔记、改写文案、生成表格、翻译。如果你已经在用 Notion 管理知识，AI 插件顺手好用。</p>
    <p><strong>免费额度</strong>：Notion 免费版 + Notion AI 试用</p>
    <h3>9. Perplexity AI（AI 搜索）</h3>
    <p>做调研的神器。跟 ChatGPT 不同，Perplexity 每条回答都附出处链接。用来做调研、事实核查、数据搜集一流。</p>
    <p><strong>免费额度</strong>：约 20 次深度搜索/天</p>
    <h3>10. Otter.ai（会议转录）</h3>
    <p>采访、会议、播客录音 → 自动转录 → AI 总结。做采访类内容的创作者必备。免费版：每月 300 分钟。</p>
    <p><strong>免费额度</strong>：300 分钟/月</p>

    <h2>推荐组合</h2>
    <p>这是我每天在用的：</p>
    <ul><li><strong>写作</strong>：DeepSeek（中文初稿） + Claude（长文润色）</li><li><strong>图片</strong>：Leonardo AI（生成） + Canva（排版） + Remove.bg（去背景）</li><li><strong>视频</strong>：CapCut（剪辑） + ElevenLabs（配音）</li><li><strong>调研</strong>：Perplexity（搜索） + Notion（整理）</li></ul>
    <p>全部免费，每月零元。等收入上来再升级付费版。</p>`,
    "article.gumroad.body": `<p>Gumroad 是目前最流行的数字产品销售平台。不管你想卖电子书、Notion 模板、设计素材还是在线课程，Gumroad 都能帮你搞定。</p>
    <p>本教程带你走完全流程：注册 → 设置 → 上传产品 → 收款 → 卖出第一单。</p>

    <h2>为什么选 Gumroad？</h2>
    <p>相比其他平台，Gumroad 有三个核心优势：</p>
    <ul>
      <li><strong>零门槛</strong>：不需要营业执照、不需要公司，个人就能注册</li>
      <li><strong>品类不限</strong>：电子书、模板、预设、课程、代码、设计源文件——任何数字文件都能卖</li>
      <li><strong>内置支付</strong>：支持信用卡和 PayPal，钱直接打到你账上</li>
    </ul>
    <p>费用结构：免费版抽 10% 佣金，付费版（$10/月）只抽 2.9% + 30¢。如果你月销售额超过 $100，上付费版更划算。</p>

    <h2>第一步：注册 Gumroad</h2>
    <p>去 <a href="https://gumroad.com" target="_blank" rel="nofollow">gumroad.com</a> 点 Sign Up。用 Google 账号或邮箱注册。注册后需要设置：</p>
    <ol>
      <li><strong>个人资料</strong>：头像、简介（一句话说清楚你卖什么）、社交媒体链接</li>
      <li><strong>收款设置</strong>：绑定 Stripe（用来收钱）。非美国用户可能需要其他方案——下面单独讲</li>
      <li><strong>自定义链接</strong>：把默认的随机字符串改成你的名字，比如 gumroad.com/你的名字</li>
    </ol>

    <h2>第二步：创建第一个产品</h2>
    <p>点击 Products → New Product，你会看到这些选项：</p>
    <ul>
      <li><strong>产品名称</strong>：直接明了比花哨重要。"Notion 项目管理模板"比"终极效率利器"好 100 倍</li>
      <li><strong>定价</strong>：新手从 $5-$15 开始——低价好卖，先积累评价</li>
      <li><strong>产品描述</strong>：从买家视角写——"你将得到什么""这个产品解决什么问题""包含哪些文件"</li>
      <li><strong>封面图</strong>：1600×840 像素，干净专业</li>
      <li><strong>文件上传</strong>：支持 ZIP、PDF、图片等格式</li>
    </ul>

    <h2>第三步：定价策略</h2>
    <p>Gumroad 提供灵活的定价方式：</p>
    <ul>
      <li><strong>固定价格</strong>：适合大多数产品</li>
      <li><strong>自由出价</strong>：设最低价，买家愿多给就多给（粉丝经济效果好）</li>
      <li><strong>分期付款</strong>：高价产品（$100+）可分 3-6 期</li>
      <li><strong>折扣码</strong>：创建限时折扣促进销售</li>
    </ul>
    <p>一个有效的策略：<strong>出两个版本</strong>。基础版 $9，完整版 $19。大多数人会选中档。这叫做"锚定效应"。</p>

    <h2>第四步：如何推广</h2>
    <p>上架只是开始，真正难的是让人知道你的产品存在。这些方法很实用：</p>
    <ol>
      <li><strong>社交媒体</strong>：在 Twitter/X 和相关 Reddit 社区分享你的产品故事和使用场景</li>
      <li><strong>写教程文章</strong>：写一篇跟你产品相关的教程（就像你正在读的这篇），文末放产品链接</li>
      <li><strong>Product Hunt 发布</strong>：数字工具类产品最好的冷启动渠道</li>
      <li><strong>建邮件列表</strong>：用 Gumroad 自带的邮件功能收集买家邮箱，有新货第一时间通知</li>
    </ol>

    <h2>常见问题</h2>
    <h3>非美国创作者怎么收款？</h3>
    <p>Gumroad 默认通过 Stripe 收款。如果 Stripe 在你的国家不支持，替代方案包括注册美国公司（通过 Stripe Atlas）、用支持地区的 Stripe 账号、或通过 Payoneer 中转。</p>

    <h3>需要交税吗？</h3>
    <p>Gumroad 自动代收代缴欧盟 VAT。美国卖家需要填 W-9 表。具体情况咨询会计师。</p>`,
    "article.ideas.body": `<p>想做数字产品但不知道卖什么？这是最常见的卡点。好消息是：不用发明新东西——这些方向已经有很多人在赚钱了。</p>

    <h2>入门级（门槛最低）</h2>

    <h3>1. Notion 模板</h3>
    <p>2026 年最热的数字产品之一。项目管理、习惯追踪、财务管理、读书笔记——任何工作流都能做成模板。定价 $5-$30，制作时间 2-4 小时。真实案例：有人在 Gumroad 靠 3 个 Notion 模板月入 $2000+。</p>

    <h3>2. Canva 模板</h3>
    <p>社媒帖子、简历、PPT、海报。Canva 有 1.5 亿用户，模板需求巨大。一套 10 个 Instagram 模板卖 $8——大把人买。</p>

    <h3>3. 电子书（短篇）</h3>
    <p>不需要写 300 页。30-50 页的"微电子书"反而更好卖——定价低（$3-9）、决策成本低、读完率高。主题要窄："写给写手的 20 个 Upwork 竞标模板"比"如何做自由职业"好卖。</p>

    <h3>4. 清单 / PDF 文档</h3>
    <p>最简单的数字产品。比如"SEO 入门清单"或"远程办公配置清单"。1-2 页 PDF，卖 $1-3，30 分钟搞定。单个利润低但走量。</p>

    <h3>5. 社媒内容日历</h3>
    <p>很多小企业主需要规划社媒内容但不知道怎么弄。做一个 30 天内容日历模板（Google Sheets + PDF），卖 $7-12。</p>

    <h2>进阶级（需要一定技能）</h2>

    <h3>6. 预设包（Lightroom / Figma / VS Code）</h3>
    <p>摄影师要 Lightroom 预设，设计师要 Figma 插件/组件库，开发者要 VS Code 主题/配置。做一个高质量预设包，定价 $15-35，复购率高。</p>

    <h3>7. 在线微课</h3>
    <p>不是 Udemy 那种 10 小时大课。30-60 分钟的"微课程"，解决一个具体问题。比如"30 分钟学会用 AI 做 PPT"。定价 $15-29。</p>

    <h3>8. 字体 / 图标包</h3>
    <p>手写字体、手绘图标、自定义表情——设计师和内容创作者永远需要这些素材。一套 50 个图标卖 $10-20。</p>

    <h3>9. 网站/应用模板</h3>
    <p>Next.js 模板、Framer 模板、Webflow 模板。前期投入较高（好模板可能做两周），但定价高（$29-79），可以反复卖。</p>

    <h3>10. 表格模板</h3>
    <p>预算表、项目管理表、客户 CRM 表。Google Sheets/Excel 模板是长青市场。定价 $5-20。</p>

    <h2>高阶（需要专业技能）</h2>

    <h3>11. SaaS 微工具</h3>
    <p>一个小工具（Chrome 插件、Figma 插件），一次性购买或 freemium 模式。开发 1-4 周，成功就是真正的被动收入。</p>

    <h3>12. 3D 资产/模型</h3>
    <p>网页 3D 需求爆发。Blender 模型、Spline 场景、Three.js 组件——供不应求。单个模型 $5-50。</p>

    <h3>13. 提示词合集</h3>
    <p>AI Prompt Engineering 是新兴品类。"100 个 ChatGPT 商业写作提示词""200+ Midjourney 风格关键词"。定价 $5-19。</p>

    <h3>14. 数据报告</h3>
    <p>行业分析报告、市场研究数据。调研花时间，但一份 $49-199 的报告可以反复卖。</p>

    <h3>15. 音频素材包</h3>
    <p>免版税背景音乐、音效包。YouTube 创作者和播客主都需要。定价 $15-49。</p>

    <h2>怎么选？三个标准</h2>
    <ol>
      <li><strong>你现有的技能</strong>：设计 → 模板，写作 → 电子书，编程 → SaaS 微工具</li>
      <li><strong>制作时间</strong>：新手从 4 小时内能完成的产品开始（模板、清单）</li>
      <li><strong>市场需求</strong>：在 Gumroad 搜同类产品看销量。有人卖说明有需求</li>
    </ol>`,
    "article.notion-templates.body": `<p>"卖 Notion 模板能赚钱吗？"——两年前我也问过同样的问题。现在我可以直接回答：<strong>能，而且比你想的赚得多。</strong></p>

    <h2>Notion 模板市场有多大？</h2>
    <p>Notion 用户超 1 亿。到 2026 年，Notion 模板已经是一个成熟的数字产品品类。Gumroad 上标记"Notion 模板"的产品超过 10 万个，头部卖家月入 $5,000-$15,000。</p>

    <h2>最好卖的模板类型</h2>
    <h3>1. 个人管理系统（销量冠军）</h3>
    <p>把任务管理、习惯追踪、目标规划、日记整合到一个 Notion 页面。就是所谓"第二大脑"。这类模板定价 $15-39，头部产品售出 5000+ 份。</p>

    <h3>2. 项目管理模板</h3>
    <p>不想花钱买 Jira/Asana 的自由职业者和小团队，自己在 Notion 里搭项目管理。包含任务看板、时间线、甘特图。定价 $9-25。</p>

    <h3>3. 财务管理模板</h3>
    <p>收支记账、发票管理、税务记录。自由职业者尤其喜欢这个品类。定价 $8-19。</p>

    <h3>4. 学术/学生模板</h3>
    <p>课程表、笔记系统、考试复习计划。学生群体大，单价低但走量。定价 $3-10。</p>

    <h3>5. 内容创作工作流</h3>
    <p>面向 YouTuber 和博主：选题库、脚本管理、发布日历、数据追踪。垂直品类，付费意愿强。定价 $12-29。</p>

    <h2>真实收入案例</h2>
    <p>来自 Gumroad 公开数据和创作者披露：</p>
    <ul>
      <li>第二大脑模板：$39 × 5,000+ 销量 = $195,000+（上线两年）</li>
      <li>自由职业者管理系统：$19 × 1,200+ 销量 = $22,800+（一年）</li>
      <li>学生笔记模板套装：$12 × 3,000+ 销量 = $36,000+（18 个月）</li>
      <li>小项目管理模板：$15 × 800 销量 = $12,000（8 个月）</li>
    </ul>

    <h2>做好模板需要什么？</h2>
    <p>不需要写代码。你需要的是：</p>
    <ol>
      <li><strong>对某个工作流程的深刻理解</strong>：你必须经历过这个痛点。做学生模板？你得当过学生。做自由职业者模板？你得接过单</li>
      <li><strong>Notion 熟练度</strong>：数据库关联、公式、自动化、不同视图——基本功要会</li>
      <li><strong>设计感</strong>：丑模板卖不出去。配色统一、排版干净、信息层级清晰</li>
    </ol>
    <p>做一个模板 4-8 小时。第一次久，熟练后 2-3 小时。</p>

    <h2>怎么推广模板？</h2>
    <ul>
      <li><strong>在 Twitter/X 发截图</strong>：展示模板界面 + 效果，打 Notion 社区标签</li>
      <li><strong>Reddit r/Notion</strong>：最有价值的推广渠道——发免费版作为引流</li>
      <li><strong>Product Hunt 发布</strong>：创新型模板效果好</li>
      <li><strong>免费版引流</strong>：免费版有基础功能，Pro 版解锁高级功能</li>
    </ul>`,
    "article.notion-workflow.body": `<p>大多数人用 Notion 是这样：今天建个页面写笔记，明天建个页面列任务，一周后页面散落各处，什么都找不到。这不是 Notion 的问题——是你缺一个工作流框架。</p>
    <p>这篇指南给你一套可以直接抄的 Notion 工作流。核心原则：<strong>用尽量少的页面覆盖所有日常场景。</strong></p>

    <h2>工作流总览：一个 Dashboard 管所有</h2>
    <p>创建主页叫"Dashboard"，这是你每天打开 Notion 看到的唯一页面。在上面嵌入所有子模块的视图。</p>

    <h2>第一步：建任务收件箱</h2>
    <p>建一个 Database 叫"任务收件箱"，用列表视图。字段：</p>
    <ul><li>任务名（标题）</li><li>状态（选择）：待办 / 进行中 / 完成</li><li>优先级（选择）：高 / 中 / 低</li><li>截止日期（日期）</li><li>所属项目（关联 → 链接到项目看板）</li></ul>
    <p>核心规则：<strong>任何想法、任务、提醒，立刻丢进收件箱</strong>。不要"等会儿再记"，不要"我会记住的"。养成反射：念头冒出来 → 手指敲进 Notion。</p>
    <p>每天早上花 3 分钟清收件箱：今天要做的 → 标高优先级+今日截止；以后做的 → 标低优先级；不需要的 → 删掉。</p>

    <h2>第二步：建项目看板</h2>
    <p>再建一个 Database 叫"项目"，用看板视图。字段：</p>
    <ul><li>项目名</li><li>状态：规划中 → 进行中 → 暂停 → 完成</li><li>截止日期</li><li>关联任务（关联 → 链接到任务收件箱）</li></ul>
    <p>每个项目是一张卡片，里面写项目描述、关键结果、关联的任务。一个页面看所有项目进度。</p>

    <h2>第三步：建知识库</h2>
    <p>再建一个 Database 叫"知识库"——你的第二大脑。分类：</p>
    <ul><li>文章/教程笔记</li><li>会议记录</li><li>想法/灵感</li><li>收藏/高亮</li></ul>
    <p>不要过度分类。Notion 搜索很强大——用标签（多选）代替文件夹结构。标签如：#SEO、#变现、#WebDev、#AI。按标签搜比翻文件夹快 10 倍。</p>

    <h2>第四步：设周回顾模板</h2>
    <p>在 Dashboard 底部放一个 Toggle List，写固定周回顾问题：</p>
    <ul><li>本周完成了什么？（筛选任务库"已完成"）</li><li>什么没做完？为什么？</li><li>下周前三大事？</li><li>学到了什么新东西？</li></ul>
    <p>每周日花 15 分钟回答这 4 个问题。这是整个系统最重要的环节——不复盘，前三个步骤白做。</p>

    <h2>最终 Dashboard 布局</h2>
    <p>把 4 个模块放在一个页面，用分栏布局：</p>
    <ul><li>左栏 70%：任务收件箱（今日视图）+ 项目看板</li><li>右栏 30%：快捷链接 + 知识库最近更新</li><li>底部：周回顾</li></ul>
    <p>每天打开 Notion，第一眼看到的就是你今天该做的事。不再到处找信息，大脑负担大幅降低。</p>`,
    "article.upwork.body": `<p>Upwork 是全球最大的自由职业平台，2026 年活跃项目超 200 万个。不管你是程序员、设计师、写手还是翻译，都有大把接单机会。</p>
    <p>但 90% 的新人第一周就放弃了——因为不会写 Proposal。投 20 个零回复。这篇指南就是来解决这个问题的。</p>

    <h2>第一步：注册和避免被拒</h2>
    <p>很多人注册就被拒。被拒原因：技能填太宽、资料太空、头像像假的。修改后重新提交。</p>

    <h2>第二步：Profile 优化——让客户来找你</h2>
    <p>好 Profile 不是"我懂 Python、JS、React"——而是"我能帮你解决什么问题"。对比一下：</p>
    <blockquote>❌ "我是一名有 5 年 React 和 Node.js 经验的网页开发者。"<br>✅ "我为 SaaS 创业公司做高转化落地页。最近 3 个客户上线 2 周内试用注册量提升 40%+。"</blockquote>
    <p><strong>Profile 黄金公式</strong>：Title = 技能 + 结果 + 目标客户。例如："AI 写作写手——SaaS 博客方向，已发布 200+ 篇文章"。</p>

    <h2>第三步：写 Proposal——最关键的一步</h2>
    <p>Upwork 的 Proposal 不是简历——是"解决方案"。客户不在乎你是谁，只在乎一件事："你能帮我把这事搞定吗？"</p>
    <h3>Proposal 模板（直接抄）</h3>
    <pre>Hi [客户名]，

我刚看了你的项目需求，关于 [简要概括项目]。
...
祝好，
[你的名字]</pre>
    <p>关键点：<strong>前两行必须让客户知道你认真看了他的需求</strong>。90% 的 Proposal 是复制粘贴的模板。稍微定制一下，你就能脱颖而出。</p>

    <h2>第四步：定价策略</h2>
    <p>新手最纠结的问题：该报多少价？</p>
    <p><strong>策略：前 3 单低价攒评价，之后正常报价。</strong></p>
    <ul><li>第 1-3 单：报市场价的 60%-70%。目标不是赚钱——是 5 星好评</li><li>第 4-10 单：正常报价。争取 90%+ Job Success Score</li><li>第 10 单后：每 3-5 单涨价 10%-20%，直到找到你的天花板</li></ul>
    <p>参考价位（2026 年）：写作 $30-80/篇，Web 开发 $40-100/小时，设计 $25-60/小时。</p>

    <h2>第五步：常见坑别踩</h2>
    <ul><li><strong>绝不在平台外沟通或收款</strong>：Upwork 会封号，而且失去支付保护</li><li><strong>绝不做"先做个样品看看"的活</strong>：免费样品 = 白干</li><li><strong>用 Upwork 的时间追踪器</strong>：按时计费项目必须用；纠纷时有凭据</li><li><strong>不要同时接太多单</strong>：质量下降 → 差评 → 更难接单 = 恶性循环</li></ul>

    <h2>多久能月入 $1000？</h2>
    <p>真实数据：每天投入 2-3 小时，第一个月 $100-300，第三个月 $500-800，第六个月稳定 $1000+。具体看你的技能和投入。</p>
    <p>强的程序员和设计师可能第一个月就 $1000。写手和翻译可能需要 2-3 个月。</p>`,
